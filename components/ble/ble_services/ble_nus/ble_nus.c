...
#define BLE_UUID_NUS_TX_CHARACTERISTIC 0x2000                      /**< The UUID of the TX Characteristic. */
#define BLE_UUID_NUS_RX_CHARACTERISTIC 0x2001                      /**< The UUID of the RX Characteristic. */

#define BLE_NUS_MAX_RX_CHAR_LEN        BLE_NUS_MAX_DATA_LEN        /**< Maximum length of the RX Characteristic (in bytes). */
#define BLE_NUS_MAX_TX_CHAR_LEN        BLE_NUS_MAX_DATA_LEN        /**< Maximum length of the TX Characteristic (in bytes). */

#define NUS_BASE_UUID                  {{0x68, 0xf3, 0x1b, 0xa4, 0xa8, 0xd8, 0x1a, 0x96, 0x3e, 0x45, 0x07, 0x6c, 0x00, 0x00, 0xc3, 0xa6}} /**< Used vendor specific UUID. */
